...
const VantaFogBackground = lazy(
  () => import("../components/VantaFogBackground"),
);
        ...
        <div className="container">
          <div className="text-content">
            ...
            <p className="home-text">
              Hey there! 👋 I'm a software engineer with over two years of
              experience in technology solutions. Throughout my career, I've
              developed using a variety of technologies; currently, I'm focused
              on Front-End development, leading teams, and accelerating
              processes using AI agents. I love teaching and learning with every
              completed project, so if you have something in mind, don't
              hesitate to get in touch 🤝
            </p>
            <div className="buttons-container">
              <a
                href="https://drive.google.com/uc?export=download&id=1KL8lJo2vfbs5NGPacstFUa280doC61FW"
              ...
              <button
                ...
                onClick={(e) => handleSmoothScroll(e, contactRef, 60)}
              >
                Contact Me
              </button>
            </div>
