...
const projects = [
  {
    id: 1,
    image:
      "https://res.cloudinary.com/dmfs1od9n/image/upload/f_auto,q_auto,w_auto/v1745263470/React-tech-Slider-Demo_e9ozt4.png",
    alt: "NPM package",
    ...
    technologies: [
      ...
      {
        logo: "https://img.icons8.com/fluency/240/nextjs.png",
        name: "Next.js",
      },
      {
        ...
        {projects.map((project) => (
          <article key={project.id} className="project-card">
            ...
            <div className="project-content">
              ...
              <div
                className={`project-technologies-wrapper ${project.id === 1 ? "mask-wrapper" : ""}`}
              >
                <div
                  className={`project-technologies ${project.id === 1 ? "animate" : ""}`}
                >
